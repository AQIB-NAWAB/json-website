const jsonSchemaReferences: Record<string, Record<string, string>> = {
  objectProperty: {
    ...
    'patternProperties': '/understanding-json-schema/reference/object#patternProperties',
    'additionalProperties': '/understanding-json-schema/reference/object#additionalproperties',
    'dependentRequired': '/understanding-json-schema/reference/conditionals#dependentRequired',
    'dependentSchemas': '/understanding-json-schema/reference/conditionals#dependentSchemas',
