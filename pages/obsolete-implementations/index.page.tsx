...
export async function getStaticProps() {
  ...
  const hyperLibaries = yaml.load(fs.readFileSync('data/hyper-libraries-obsolete.yml', 'utf-8'))

  const intro = fs.readFileSync('pages/obsolete-implementations/intro.md', 'utf-8')
  const main = fs.readFileSync('pages/obsolete-implementations/main.md', 'utf-8')
  const main2 = fs.readFileSync('pages/obsolete-implementations/main2.md', 'utf-8')
