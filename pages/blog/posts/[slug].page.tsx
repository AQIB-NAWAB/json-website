    ...
    <SectionContext.Provider value='blog'>
      <Layout>
        ...
        <div className='bg-slate-100'>
          <div className='flex flex-col py-12 bg-white xl:w-[1200px] mx-auto '>
            {frontmatter.date && (
        ...
        <div className='bg-slate-100'>
          <div className='relative flex flex-col lg:flex-row bg-white xl:w-[1200px] mx-auto px-2 sm:px-4 lg:px-8'>
